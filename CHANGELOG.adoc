...
- badge on link:./README.adoc[README]
...
- Update link:./README.adoc[README]
...
- Update link:./.github/ISSUE_TEMPLATE.adoc[ISSUE_TEMPLATE]
- Update link:./.github/PULL_REQUEST_TEMPLATE.adoc[PULL_REQUEST_TEMPLATE]
